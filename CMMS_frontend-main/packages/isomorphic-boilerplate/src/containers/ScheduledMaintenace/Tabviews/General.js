      ...
      if (Object.keys(scheduledmaintenance).length != 0) {
        if (scheduledmaintenance.intChargeDepartmentID != null) {
          setStrChargeDepartment(
            '(' +
              scheduledmaintenance.intChargeDepartmentID.strCode +
              ')' +
              scheduledmaintenance.intChargeDepartmentID.strDescription
          );
          setIntChargeDepartment(
            scheduledmaintenance.intChargeDepartmentID._id
          );
          props.selectedChargeDepartment(
            scheduledmaintenance.intChargeDepartmentID
          );
        }
        if (scheduledmaintenance.intAccountID != null) {
          setStrAccount(
            '(' +
              scheduledmaintenance.intAccountID.strCode +
              ')' +
              scheduledmaintenance.intAccountID.strDescription
          );
        ...
        if (scheduledmaintenance.intAssignedToUserID != null) {
          setStrAssignedUsers(
            scheduledmaintenance.intAssignedToUserID.strFullName
          );
        ...
        setDblTimeEstimatedHours(
          parseFloat(scheduledmaintenance.dblTimeEstimatedHours)
        );
