...
const MyDocument = ({ purchaseOrder, fileLists }) => {
  let strCardType = '';
  ...
  let subTotalPrice = 0;
  let totalPrice = 0;
  let strCardHolderName = '';
  let intCardNumber = '';
  let dtmExpirationDate = '';
  let strBillToAddress = '';
  let strZipCode = '';
  let frontStrLink = '';
  let backStrLink = '';
  if (purchaseOrder) {
    ...
    strCardType = purchaseOrder.purchaseOrder.intCreditCardID.strCardType;
    strCardHolderName =
      purchaseOrder.purchaseOrder.intCreditCardID.strCardHolderName;
    intCardNumber = purchaseOrder.purchaseOrder.intCreditCardID.intCardNumber;
    dtmExpirationDate = moment(
      purchaseOrder.purchaseOrder.dtmExpirationDate
    ).format('D MMMM YYYY');
    strBillToAddress = purchaseOrder.purchaseOrder.strBillToAddress;
    strZipCode = purchaseOrder.purchaseOrder.intCreditCardID.strZipCode;
    if (fileLists != '') {
      let link = fileLists.filter((item) => item.strCardImage == 'front');
      link.map((item) => {
        frontStrLink = item.strLink;
      });
      frontStrLink = frontStrLink.substr(6, frontStrLink.length);
      frontStrLink = siteConfig.apiUrl + frontStrLink;
      let temp = fileLists.filter((item) => item.strCardImage == 'back');
      link.map((item) => {
        backStrLink = item.strLink;
      });
      backStrLink = backStrLink.substr(6, backStrLink.length);
      backStrLink = siteConfig.apiUrl + backStrLink;
      console.log('this is line', frontStrLink, backStrLink);
    }
  }
          ...
          <View style={styles.pageMargin}>
            ...
            <View style={styles.block}>
              ...
              >
                ...
                <Text style={styles.textCont1}>{strCardHolderName}</Text>
              </View>
              <View
                style={{
                  flexDirection: 'row',
              ...
              >
                ...
                <Text style={styles.textCont1}>{intCardNumber}</Text>
              </View>
              <View
                style={{
                  flexDirection: 'row',
              ...
              >
                ...
                <Text style={styles.textCont1}>{dtmExpirationDate}</Text>
              </View>
              <View
                style={{
                  flexDirection: 'row',
              ...
              >
                ...
                <Text style={styles.textCont1}>{strBillToAddress} </Text>
              </View>
              <View
                style={{
                  flexDirection: 'row',
              ...
              >
                ...
                <Text style={styles.textCont1}>{strZipCode}</Text>
              </View>
              <View
                style={{
                  flexDirection: 'row',
              ...
              >
                ...
                >
                  I, [ ], authorize [ ] to charge my credit card above for
                  agreed upon service / purchase corresponding with Purchase
                  Order [ ].
                </Text>
              </View>
              <View style={styles.tableRow}>
                <View
                  style={[styles.tableCol, { width: '50%', minHeight: '50px' }]}
                >
                  <Text
                    style={{
                      fontFamily: 'PT Sans',
                  ...
                  <Text style={[styles.textCont2]}></Text>
                </View>
                <View style={{ width: '50%' }}>
                  <Text
                    style={{
            ...
            >
              ...
              >
                153 E. Flagler St. #1760 Miami, FL 33131
              </Text>
            </View>
          </View>
        )}
...
export default function (props) {
  ...
  React.useEffect(() => {
    if (purchaseOrder) {
      dispatch(
        getFilesByCreditCard(purchaseOrder.purchaseOrder.intCreditCardID._id)
      );
      // setFiles(fileLists);
  ...
  React.useEffect(() => {
    ...
    // setIntCardID(printData.purchaseOrder.intCreditCardID._id);
        ...
        <Box>
          <PageWrapper className="editView">
            ...
            <Button color="primary">
              <PDFDownloadLink
                document={
                  <MyDocument purchaseOrder={printData} fileLists={fileLists} />
                }
                fileName={`WO-${id}.pdf`}
              >
