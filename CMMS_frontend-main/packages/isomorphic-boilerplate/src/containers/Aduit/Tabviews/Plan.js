    ...
    <div className="PageContent">
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={24} sm={24} xs={24} style={colStyle}>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aDate != null ? moment(aDate, "YYYY-MM-DD HH:mm:ss") : ""
                    }
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aOpenMeetingBegin != null
                        ? moment(aOpenMeetingBegin, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setAOpenMeetingBegin(
                        dataString == "" ? null : moment(dataString)
                      )
                    }
                  />
                </Fieldset>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aOpenMeetingClose != null
                        ? moment(aOpenMeetingClose, "YYYY-MM-DD")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setAOpenMeetingClose(dataString==""?null:moment(dataString))
                    }
                  />
                </Fieldset>
              </Form>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aOpenMeetingPresent != null
                        ? moment(aOpenMeetingPresent, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setAOpenMeetingPresent(dataString)
                    }
                  />
                </Fieldset>
              </Form>
          ...
          ></div>
          <Label>
            Conduct of audit (where more than one element is to be audited,
            several start and finish times may be given)
          </Label>
          <Row style={rowStyle} gutter={gutter} justify="start">
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aConductAuditBegin != null
                        ? moment(aConductAuditBegin, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setAConductAuditBegin(dataString)
                    }
                  />
                </Fieldset>
              </Form>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aConductAuditClose != null
                        ? moment(aConductAuditClose, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setAConductAuditClose(dataString==""?null:moment(dataString))
                    }
                  />
                </Fieldset>
              </Form>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aCloseMeetingBegin != null
                        ? moment(aCloseMeetingBegin, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setACloseMeetingBegin(dataString)
                    }
                  />
                </Fieldset>
              </Form>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aCloseMeetingClose != null
                        ? moment(aCloseMeetingClose, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setACloseMeetingClose(dataString==""?null:moment(dataString))
                    }
                  />
                </Fieldset>
              </Form>
            ...
            <Col md={6} sm={6} xs={12} style={colStyle}>
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      aCloseMeetingPresent != null
                        ? moment(aCloseMeetingPresent, "YYYY-MM-DD HH:mm:ss")
                        : ""
                    }
                    onChange={(value, dataString) =>
                      setACloseMeetingPresent(dataString)
                    }
                  />
                </Fieldset>
              </Form>
