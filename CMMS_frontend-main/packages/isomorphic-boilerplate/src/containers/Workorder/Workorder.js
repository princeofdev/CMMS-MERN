...
export default function Workorders() {
  ...
  const columns = [
    ...
    {
      title: 'SM',
      dataIndex: 'intScheduledMaintenanceID',
      key: 'intScheduledMaintenanceID',
      width: '15%',
      render: (text) => {
        return text ? (
          <a
            onClick={() => {
              history.push(`/dashboard/scheduledmaintenance/${text}`);
            }}
          >
            {'SM ' + text}
          </a>
