...
export default function(props) {   
  ...
  React.useEffect(() => { 
    ...
    if(pageState=="edit"){
      ...
      setStrWorkInstruction(workorder.workorder.strWorkInstruction?workorder.workorder.strWorkInstruction:"");
                   ...
                   <Col md={8} sm={8} xs={24} >
                     ...
                     <Form>
                      <Fieldset>
                        ...
                        <FormItem
                          validateStatus={strWorkInstruction == ""? "error" : "success"}
                        ...
                        <Textarea placeholder="" 
                          ...
                          onChange={(event)=>{setStrWorkInstruction(event.target.value);props.strWorkInstructionChange(event.target.value)}}                               
                        /> 
                      </FormItem>
                    </Fieldset>
                    </Form> 
