...
export default function (props) {
  ...
  const [
    equipmentPartModalActive,
    setEquipmentPartModalActive,
  ] = React.useState(false);
  const [
    equipmentLocatedModalActive,
    setEquipmentLocatedModalActive,
  ] = React.useState(false);
  ...
  React.useEffect(() => {
    if (pageState == 'edit') {
      ...
      setEstimatedStartTime(
        workorder.workorder.dtmEstimatedStartTime == undefined
          ? ''
          : workorder.workorder.dtmEstimatedStartTime
      );
      ...
      if (Object.keys(workorder.assignedUser).length !== 0) {
        // setAssigneduser(workorder.assignedUser.strFullName);
          ...
          <Col md={8} sm={8} xs={24}>
                ...
                >
                  <Textarea
                    ...
                    onChange={(event) => {
                      ...
                      props.strDescriptionChange(event.target.value);
                    }}
                  />
                </FormItem>
              </Fieldset>
            ...
            <Form>
              <Fieldset>
                ...
                <FormItem
                  validateStatus={
                    strWorkInstruction == '' ? 'error' : 'success'
                  }
                  help={strWorkInstruction == '' ? 'this field is require' : ''}
                >
                  <Textarea
                    placeholder=""
                    style={{ height: 'auto' }}
                    ...
                    onChange={(event) => {
                      setStrWorkInstruction(event.target.value);
                      props.strWorkInstructionChange(event.target.value);
                    }}
                  />
                </FormItem>
              </Fieldset>
                ...
                <Fieldset>
                  ...
                  <div style={{ position: 'relative' }}>
                    <FormItem
                      hasFeedback
                      validateStatus={
                        strAssignedUsers == '' ? 'error' : 'success'
                      }
                      help={
                        strAssignedUsers == '' ? 'this field is require' : ''
                      }
                      style={{ width: '90%' }}
                    >
                      <Input
              ...
              <Col md={13} sm={13} xs={13}>
                <Form>
                  <Fieldset style={{ paddingBottom: '10px' }}>
                    ...
                    <FormItem
                      validateStatus={
                        estimatedStartDate == null ? 'error' : 'success'
                      }
                      help={
                    ...
                    >
                      <DatePicker
                        value={
                          estimatedStartDate != null
                            ? moment(estimatedStartDate, 'YYYY-MM-DD')
                            : ''
                        }
                        onChange={(value, dateString) => {
                          ...
                          props.setEstimatedStartDate(
                            dateString == '' ? null : moment(dateString)
                          );
                        }}
                      />
                    </FormItem>
                    ...
                    <FormItem>
                      <TimePicker
                        value={
                          estimatedStartTime == ''
                            ? null
                            : moment(estimatedStartTime, 'HH:mm:ss')
                        }
                        defaultValue={null}
                        onChange={(value) => {
                          props.setEstimatedStartTime(
                            value == null
                              ? ''
                ...
                <Fieldset>
                  ...
                  <div style={{ position: 'relative' }}>
                    <FormItem
                      hasFeedback
                      validateStatus={
                        strEstimatedHours != '' && isNumeric(strEstimatedHours)
                          ? 'success'
                          : 'error'
                      }
                      help={
                ...
                <Fieldset>
                  ...
                  <div style={{ position: 'relative' }}>
                    <Input
                      ...
                      style={{ width: '100px' }}
                    />
                    <label style={{ top: '4px', position: 'absolute' }}>
                      hours
                    </label>
                  </div>
                </Fieldset>
              ...
              <Form>
                <Fieldset>
                  ...
                  <DatePicker
                    value={
                      completedDate != null
                        ? moment(completedDate, 'YYYY-MM-DD')
                        : ''
                    }
