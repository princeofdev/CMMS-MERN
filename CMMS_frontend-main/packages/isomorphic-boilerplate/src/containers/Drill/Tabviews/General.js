...
export default function (props) {
  ...
  const [crewContentModalActive, setCrewContentModalActive] = React.useState(
    false
  );
  const [crewContentModal2Active, setCrewContentModal2Active] = React.useState(
    false
  );
  ...
  React.useEffect(() => {
    if (data != null) {
      ...
      setCrewIds(data.strParticipatingCrewIds);
      setCrewList(data.strCrewLists ? data.strCrewLists : '');
    }
  }, [data]);
                  ...
                  <Fieldset>
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <i
                        ...
                        onClick={() => {
                          setCrewContentModalActive(true);
                        }}
                        style={{
                          fontSize: '25px',
                          cursor: 'pointer',
                ...
                <Form>
                  <Fieldset>
                    ...
                    <Textarea
                      ...
                      onChange={(event) => {
                        setStrDrillDescription(event.target.value);
                        props.strDrillDescription(event.target.value);
                      }}
                    />
                  </Fieldset>
                </Form>
          ...
          <Col md={5} sm={5} xs={24}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div
                ...
                onClick={() => setCrewContentModal2Active(true)}
              >
                <img
                ...
                >
                  Add another participating crew
                </span>
              </div>
            </div>
          </Col>
