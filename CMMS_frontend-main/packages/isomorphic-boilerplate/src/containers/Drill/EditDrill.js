...
const { deleteData, updateData, getById } = drillAction;
...
export default function (props) {
  ...
  const [
    drillCategoryModalActive,
    setDrillCategoryModalActive,
  ...
  const onSave = (state) => {
    var sendData = {
      ...
      operationUser: localStorage.getItem('user_name'),
  ...
  const onPDF = () => {
    history.push(`/dashboard/drill/print/${id}`);
  };
  ...
  const onChange2 = (value, dateString) => {
    setDueDate(dateString == '' ? null : moment(dateString));
  };
  ...
  React.useEffect(() => {
    if (Object.keys(drill).length !== 0) {
      ...
      setStrCrewLists(drill.strCrewLists);
      setStrParticipatingCrewIds(drill.strParticipatingCrewIds);
      let tmp = {};
      tmp.strAssignee = drill.strGeneralAssignee;
      tmp.strDescription = drill.strGeneralDescription;
      tmp.strCrewLists = drill.strCrewLists ? drill.strCrewLists : '';
      tmp.strParticipatingCrewIds = drill.strParticipatingCrewIds
        ? drill.strParticipatingCrewIds
        : '';
      setAGeneralData(tmp);
        ...
        <PageWrapper className="editView">
          <div className="PageContent">
            <Row style={rowStyle} gutter={gutter} justify="start">
              <Col md={2} sm={2} xs={24} style={colStyle}></Col>
                    ...
                    <Form>
                      <Fieldset>
                        ...
                        <Input
                          ...
                          value={strDrillTitle}
                          onChange={(event) =>
                            setStrDrillTitle(event.target.value)
                          }
                          // style={{ width: "90%" }}
                        />
                      </Fieldset>
                    ...
                    <Form>
                      <Fieldset>
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            setIntEstimatedTime(event.target.value)
                          }
                          // style={{ width: "90%" }}
                        />
                      </Fieldset>
                  ...
                  <Col md={6} sm={6} xs={12} style={colStyle}>
                    <Form>
                      <Fieldset>
                        ...
                        <DatePicker
                          value={
                            dueDate != null ? moment(dueDate, 'YYYY-MM-DD') : ''
                          }
                          onChange={onChange2}
                        />
                      </Fieldset>
