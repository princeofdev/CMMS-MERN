        ...
        <Row style={rowStyle} gutter={16} justify="start">
            ...
            <Form>
              <FormItem {...formItemLayout} label="">
                <Radio
                  ...
                  checked={partFlag}
                  onClick={(event) => {
                    setPartFlag(locatedFlag ? true : false);
                    setLocatedFlag(false);
                  }}
                >
                  {' '}
            ...
            <Form>
              <FormItem {...formItemEquipment} label="">
                <Input
                  ...
                  value={equipmentPartTxt}
                  onChange={() => setEquipmentPartModalActive(true)}
                />
              </FormItem>
            </Form>
          </Col>
          <Col md={1} sm={1} xs={1}>
            <i
              ...
              onClick={() => {
                setEquipmentPartModalActive(true);
              }}
        ...
        <Row style={rowStyle} gutter={16} justify="start">
            ...
            <Form>
              <FormItem {...formItemLayout} label="">
                <Radio
                  ...
                  checked={locatedFlag}
                  onClick={(event) => {
                    setLocatedFlag(partFlag ? true : false);
                    setPartFlag(false);
                  }}
                >
                  {' '}
            ...
            <Form>
              <FormItem {...formItemEquipment} label="">
                <Input
                  placeholder=""
                  style={{ height: '35px', fontSize: '15px' }}
                  value={equipmentLocatedTxt}
                  onChange={() => setEquipmentLocatedModalActive(true)}
                />
              </FormItem>
            </Form>
          </Col>
          <Col md={1} sm={1} xs={1}>
            <i
              className="ionicons ion-arrow-down-b"
              onClick={() => {
                setEquipmentLocatedModalActive(true);
              }}
              style={{ fontSize: '25px', cursor: 'pointer' }}
            ></i>
          </Col>
