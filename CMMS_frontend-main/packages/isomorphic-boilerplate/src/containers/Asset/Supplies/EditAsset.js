...
const { getAssetById, updateSupplyData, deleteData } = assetAction;
...
export default function () {
  ...
  const onSave = () => {
    ...
    dispatch(updateSupplyData(sendData, assetId));
  };
  ...
  const onPDF = () => {
    history.push(`/dashboard/asset/equipment/print/${assetId}`);
  };
  return (
