...
const MyDocument = ({ printData }) => {
  ...
  let assetCategory = ' ';
  let locationPart = 'Part'; //"Location":"Part"
  ...
  if (printData) {
    ...
    strBinNumber =
      printData.asset.strBinNumber != '' ? printData.asset.strBinNumber : ' ';
    strWorkInstruction =
    ...
    if (printData.asset.intAssetLocationID == null) {
      locationPart = 'Part';
        ...
        <View style={styles.pageMargin}>
          ...
          {/* <View style={styles.block}>
            ...
            <View style={styles.tableEndRow} >
              <Text style={{ paddingVertical: "5px", paddingLeft: "11pt", fontSize: 11, fontfamily: "Times New Roman", fontStyle: "normal", width: "45%" }}>Crew Member Signoff:</Text>
              <Text style={{ paddingVertical: "5px", borderBottomStyle: "solid", borderBottomWidth: 1, width: "40%" }}></Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={{ paddingVertical: "5px", paddingLeft: "11pt", fontSize: 11, fontfamily: "Times New Roman", fontStyle: "normal", width: "45%" }}>Master or Licensed Crew Member Signoff:</Text>
              <Text style={{ paddingVertical: "5px", borderBottomStyle: "solid", borderBottomWidth: 1, width: "40%" }}></Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={{ paddingVertical: "5px", paddingLeft: "11pt", fontSize: 11, fontfamily: "Times New Roman", fontStyle: "normal", width: "45%" }}>Signoff Date:</Text>
              <Text style={{ paddingVertical: "5px", borderBottomStyle: "solid", borderBottomWidth: 1, width: "40%" }}></Text>
            </View>
          </View> */}
        </View>
