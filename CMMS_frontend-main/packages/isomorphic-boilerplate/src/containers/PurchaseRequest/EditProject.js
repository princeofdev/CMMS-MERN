...
export default function (props) {
  ...
  const [isProjectComplete, setIsProjectComplete] = React.useState(false);
          ...
          <div className="PageContent">
            <Row style={rowStyle} gutter={gutter} justify="start">
              ...
              <Col>
                ...
                >
                  <Switch
                    checked={isProjectComplete ? true : false}
                  ...
                  >
                    {isProjectComplete ? 'complete' : 'uncomplete'}
                  </span>
                </div>
              </Col>
