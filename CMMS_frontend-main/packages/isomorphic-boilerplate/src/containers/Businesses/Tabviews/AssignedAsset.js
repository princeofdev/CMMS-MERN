...
export default function (props) {
  ...
  console.log(assetBusinesses);
  const [
    businessAssetModalActive,
    setBusinessAssetModalActive,
      ...
      <Scrollbars style={{ width: '100%', height: 'calc(45vh - 70px)' }}>
        <table style={{ overflow: 'auto', width: '70%' }}>
          <thead>
            <tr>
              <th style={{ width: '30%' }}>
                <span className="listHeaderLabel35">Asset</span>
              </th>
              <th>
                <span className="listHeaderLabel35">Business Class</span>
              </th>
              <th>
                <span className="listHeaderLabel35">Business Asset Number</span>
              </th>
              <th></th>
            </tr>
          </thead>
              ...
              assetBusinesses.map((row) => {
                return (
                  <tr className="listRow" key={row._id}>
                    ...
                    >
                      <p className="context" style={{ color: 'blue' }}>
                        {/* {row.intAssetID.strName ? row.intAssetID.strName : ""} */}
                      </p>
                    </td>
                    <td
                      className="column"
                    ...
                    >
                      <p className="context">
                        {businessTypes[row.intBusinessRoleTypeID]}
                      </p>
                    </td>
                    <td className="column">
                      <p className="context">{row.strBusinessAssetNumber}</p>
                    </td>
                    <td className="column">
                      <Button
                        className="DltBtn"
