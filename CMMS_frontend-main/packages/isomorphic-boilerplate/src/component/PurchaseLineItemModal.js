    ...
    <div>
      ...
      >
        ...
        >
          ...
          {/* <GeneralLine style={{ marginBottom: 10 }}>Additional Information</GeneralLine>
          <Row style={rowStyle2} gutter={16} justify="start">
            <Col md={24} sm={24} xs={24} >
              <Checkbox checked={bolProductionEquipmentDownWhileOnOrder} onChange={(event) => {
                setBolProductionEquipmentDownWhileOnOrder(event.target.checked);
              }}>
                Vessel operations is impacted and equipment is down while waiting for this item.
              </Checkbox>
            </Col>
          </Row>
          <Row style={rowStyle2} gutter={16} justify="start">
          ...
          <Row style={rowStyle2} gutter={16} justify="start">
            <Col md={10} sm={10} xs={24} >
              <Form>
                ...
                <Fieldset>
                  <div style={{ position: 'relative' }}>
                    <Input placeholder="Ship To Location"
                      style={{ width: '90%' }}
                      value={strShipToLocation}
                      onChange={() => { setShipToLocationModalActive(true); }}
                    />
                    <i
                      className="ionicons ion-arrow-down-b"
                      onClick={() => {
                ...
                <Fieldset>
                  <div style={{ position: 'relative' }}>
                    <Input placeholder=""
                      ...
                      onChange={() => { setWorkOrderModalActive(true); }}
                      style={{ width: '90%' }}
                    />
                    <i
                      className="ionicons ion-arrow-down-b"
