      ...
      callResult.data.data.map((value, index) => {
        ...
        value.completedByUser =
          value.intCompletedByUserID != null
            ...
            : '';
        value.intScheduledMaintenanceID = value.intScheduledMaintenanceID
          ? value.intScheduledMaintenanceID.toString()
          : null;
        temp.push(value);
      });
  ...
  try {
    ...
    if (callResult.response != undefined) {
      ...
      yield put({
        ...
        workorderid: callResult.data.data[0]
          ? callResult.data.data[0]._id + 1
          : null,
      });
    }
  } catch (error) {
