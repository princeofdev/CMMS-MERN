const actions = {
  ...
  UPDATE_WEATHER_ENTRY:"UPDATE_WEATHER_ENTRY",
  ...
  GET_WEATHER_DATA_REDUCER:'GET_WEATHER_DATA_REDUCER',
  initNewData:()=>({type:actions.GET_NEW_VESSEL_LIST}),
  getWeatherData:()=>({type:actions.GET_WEATHER_DATA}),
  ...
  editWeatherdata: weatherData => ({ type: actions.UPDATE_WEATHER_ENTRY, weatherData }),
