...
export function* getCodeTypes() {
  ...
  try {
    ...
    if (callResult.response != undefined) {
      ...
      yield put({
        type: actions.GET_CODE_TYPE_REDUCER,
...
export function* addCodeType({ payload }) {
...
export function* updateCodeType({ payload }) {
  ...
  try {
    const callResult = yield call(
      onPutCallReqeust,
      payload.sendData,
      `${siteConfig.apiUrl}/codetype/${payload.id}`
    );
...
export function* deleteCodeType({ payload }) {
...
export default function* rootSaga() {
  yield all([
    yield takeEvery(actions.GET_CODE_TYPE, getCodeTypes),
    yield takeEvery(actions.ADD_CODE_TYPE, addCodeType),
    yield takeEvery(actions.UPDATE_CODE_TYPE, updateCodeType),
    yield takeEvery(actions.DELETE_CODE_TYPE, deleteCodeType),
  ]);
}
