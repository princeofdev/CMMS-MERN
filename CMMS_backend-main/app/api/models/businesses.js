...
const BusinessesSchema = new Schema({
  ...
  strClassificationIds: {
    type: String,
  },
  strClassificationLists: {
    type: String,
  },
  strCustomerAccount:{//customeze by me
    type:String
  }
});
BusinessesSchema.plugin(autoIncrement.plugin, "Bussinesses");
// BusinessSchema.plugin(unique, { message: 'That strCode is already taken.' });
module.exports = mongoose.model("Bussinesses", BusinessesSchema);
