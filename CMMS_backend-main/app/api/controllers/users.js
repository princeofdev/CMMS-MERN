...
module.exports = {
    ...
    userModel.findOne({ strEmailAddress: req.body.email }, function (
      ...
      if (err) {
        ...
        if (
          ...
          const token = jwt.sign(
            {
              ...
              email: userInfo.strEmailAddress,
          ...
          var logInf = {};
          logInf.strSubject ="User ("+ userInfo.strFullName+") login." ;
          logInf.intRecipientId = userInfo._id;
          logInf.intLogType = 2;       
  ...
  logOut: function (req,res,next){
    ...
    var logInf = {};
    logInf.strSubject = "User (" + req.body.strFullName + ") logout.";
    logInf.intRecipientId = req.body.userId;
    logInf.intLogType = 2;
    logNotificationModel.create(logInf, function (err, logResult) {
    });
  },
