...
module.exports = {
  ...
  updateById: function (req, res, next) {
    ...
    data.strAccount = req.body.strAccount;
    data.strChargeDepartment = req.body.strChargeDepartment;
    data.strClassificationIds = req.body.strClassificationIds;
    data.strClassificationLists = req.body.strClassificationLists;
    data.strCustomerAccount = req.body.strCustomerAccount;
  ...
  createAndGet: async function (req, res, next) {
    ...
    if (business.length > 0) {
      ...
      businessModel.create(data, function (err, result) {
        ...
        } else res.status(200).json({ msg: "Created successfully!", data: result });
      });
    }
  },
