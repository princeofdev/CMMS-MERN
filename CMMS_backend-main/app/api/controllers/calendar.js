...
module.exports = {
	...
	getAll: async function(req, res, next) {
	 	var workorder=await	workOrderModel.find({})
		...
		// });	
		var charter= await charterModel.find({});
		var audit = await auditModel.find({});
		var drill = await drillModel.find({});
		
		res.status(200).json({msg: "Found!", workorder,charter, audit, drill});	
